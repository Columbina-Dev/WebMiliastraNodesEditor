...
export const nodeDefinitions: NodeDefinition[] = [
  ...
  // 执行节点/装备
  {
    ...
    // 6.3 改
    displayName: "设置装备词条值",
    displayNameEN: "(EN_TBC)Modify Equipment Affix Value",
    officialID: 674,
    category: "执行节点/装备",
    kind: "action",
    headerColor: EXECUTION_HEADER,
  ...
  {
    id: "action.affix.replaceAtIndex",
    // 6.3 新
    displayName: "替换装备到指定栏位",
    displayNameEN: "Replace Equipment to The Specified Slot",
    officialID: 791,
    category: "执行节点/装备",
    kind: "action",
    headerColor: EXECUTION_HEADER,
...
displayNameEN: "Modify Inventory Item Quantity",
  ...
  // 6.3 分类
  {
    ...
    displayName: "激活/关闭寻路阻挡",
    displayNameEN: "Enable/Disable Pathfinding Obstacle",
    officialID: 790,
    category: "执行节点/寻路阻挡",
    kind: "action",
    headerColor: EXECUTION_HEADER,
    ports: [
      ...
      {
        id: "pathBlockingFuncIndex",
        label: "寻路阻挡序号",
        kind: "data-in",
        valueType: "int",
        ui: { placeholder: "输入整数" },
      },
      { id: "enabled", label: "是否激活", kind: "data-in", valueType: "bool" },
    ],
  },
  {
    // 6.3 新
    id: "action.pathBlocking.funcToggle",
    displayName: "激活/关闭寻路阻挡功能",
    displayNameEN: "Enable/Disable Pathfinding Obstacle Feature",
    officialID: 789,
    category: "执行节点/寻路阻挡",
    kind: "action",
    headerColor: EXECUTION_HEADER,
  ...
  // 6.3 分类
  {
    ...
    displayName: "设置复杂造物的预设状态值",
    displayNameEN: "Set the Preset Status Value of the Complex Creation",
    officialID: 798,
    category: "执行节点/造物预设状态",
    kind: "action",
    headerColor: EXECUTION_HEADER,
    ports: [
      { id: "flowIn", label: "执行", kind: "flow-in" },
  ...
  // 6.3 分类
  {
    ...
    displayNameEN: "When Complex Creation Preset Status Changes",
    officialID: 799,
  ...
  },
  {
    ...
    displayNameEN: "Check Entity's Elemental Effect Status",
    officialID: 788,
    category: "查询节点/实体相关",
    kind: "query",
    headerColor: QUERY_HEADER,
  ...
  },
  {
    ...
    displayNameEN: "Get the Number of Waypoints in the Global Path",
    officialID: 787,
    category: "查询节点/路径",
    kind: "query",
    headerColor: QUERY_HEADER,
  ...
  },
  {
    ...
    displayNameEN: "Get the Equipment Index of the Specified Equipment Slot",
    officialID: 792,
    category: "查询节点/装备",
    kind: "query",
    headerColor: QUERY_HEADER,
  ...
  // 6.3 分类
  {
    ...
    displayNameEN: "Get the Preset Status Value of the Complex Creation",
    officialID: 797,
