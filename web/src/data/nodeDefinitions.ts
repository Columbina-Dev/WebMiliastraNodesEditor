...
export const nodeDefinitions: NodeDefinition[] = [
  ...
  },
  {
    ...
    displayNameEN: "(test)Official_action.replaceAffixAtIndex",
    officialID: 791,
    category: "执行节点/装备",
    kind: "action",
    headerColor: EXECUTION_HEADER,
...
displayNameEN: "Modify Inventory Item Quantity",
  ...
  // 执行节点/寻路阻挡
  {
    ...
    displayNameEN: "(test)Official_action.pathBlocking.toggle",
    officialID: 790,
    category: "执行节点/寻路阻挡",
    kind: "action",
    headerColor: EXECUTION_HEADER,
  ...
  },
  {
    ...
    displayNameEN: "(test)Official_action.pathBlocking.funcToggle",
    officialID: 789,
    category: "执行节点/寻路阻挡",
    kind: "action",
    headerColor: EXECUTION_HEADER,
  ...
  // 执行节点/造物预设状态
  {
    ...
    displayNameEN: "(test)Official_action.construct.setPresetState",
    officialID: 798,
  ...
  },
  {
    ...
    displayName: "按顺序唯一执行",
    displayNameEN: "(test)Official_event.executeByOrderUniquely",
    officialID: 0,
    category: "事件节点/<隐藏>客户端节点自带",
    kind: "event",
    headerColor: EVENT_HEADER,
